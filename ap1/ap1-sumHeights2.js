...
function sumHeights2(array, start, end) {
    return array
        .slice(start, end + 1)
...
console.log(sumHeights2([5, 3, 6, 7, 2], 2, 4)); // 7
console.log(sumHeights2([5, 3, 6, 7, 2], 0, 1)); // 2
console.log(sumHeights2([5, 3, 6, 7, 2], 0, 4)); // 15